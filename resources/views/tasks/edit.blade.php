            ...
            <div class="well">
                <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" rows="3" name="desc" id="task-desc">{{ $task->desc }}</textarea>
                            @if ($errors->has('desc'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('duedate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="duedate" id="task-duedate" class="form-control" value="{{ $task->duedate }}">
